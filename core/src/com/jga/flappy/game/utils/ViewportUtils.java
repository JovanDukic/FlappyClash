package com.jga.flappy.game.utils;
...
public class ViewportUtils {
    ...
    public static void drawGrid(Viewport viewport, ShapeRenderer renderer, int cellSize) {
        ...
        renderer.line(worldWidth, worldHeight, worldWidth + GameConfig.SPAWN_WIDTH, worldHeight);
        renderer.line(worldWidth + GameConfig.SPAWN_WIDTH, 0, worldWidth + GameConfig.SPAWN_WIDTH, worldHeight);

        // draw delete bounds
        renderer.line(GameConfig.DELETE_AREA_WIDTH, 0, GameConfig.DELETE_AREA_WIDTH, worldHeight);
        renderer.line(0, worldHeight, GameConfig.DELETE_AREA_WIDTH, worldHeight);

        // draw delete line
        renderer.setColor(Color.PURPLE);
        renderer.line(GameConfig.DELETE_LINE_X, 0, GameConfig.DELETE_LINE_X, worldHeight);
